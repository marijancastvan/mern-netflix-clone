  ...
  return (
    ...
    style={{backgroundImage: `url('/404.png')`}}>
        ...
        <header className='absolute top-0 left-0 p-4 bg-black w-full'>
            <Link to={"/"}>
            <img src='/netflix-logo.png' alt='Netflix' className='h-8'></img>
            </Link>
        </header>
        
        <main className='text-center error-page--content z-10'>
            <h1 className='text-7xl font-semibold mb-4'>Lost your way?</h1>
            <p className='mb-6 text-xl'>Sorry, we can't find thath page. You'll find lots to explore on the home page.</p>
