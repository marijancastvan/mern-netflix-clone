        ...
        <div className='mx-auto container px-4 py-8 h-full'>
            ...
            {trailers?.length > 0 && (
                <div className='flex justify-between items-center mb-4'>
                    <button className={`bg-gray-500 bg-opacity-70 hover:bg-gray-500 text-white py-2 px-4 rounded
            ...
            <div className='flex flex-col md:flex-row items-center  justify-between gap-20 max-w-6xl mx-auto'>
                ...
                <img src={ORIGINAL_IMG_BASE_URL + content.poster_path}
                    alt='Poster image'
                    className='max-h-[600px] rounded-md'></img>
            </div>
            ...
            {similarContent.length > 0 && (
                <div className='mt-12 max-w-5xl mx-auto relative'>
                    ...
                    <div className='flex overflow-x-scroll scrollbar-hide gap-4 pb-4 group' ref={sliderRef}>
                        ...
                        transition-all duration-300 cursor-pointer bg-red-600 text-white rounded-full'onClick={scrollRight}>
                        </ChevronRight>

                        <ChevronLeft className='absolute top-1/2 -translate-y-1/2 left-2 w-8 h-8 opacity-0 group-hover:opacity-100
                        transition-all duration-300 cursor-pointer bg-red-600 text-white rounded-full'onClick={scrollLeft}>
                        </ChevronLeft>
                    </div>
                </div>
            )}
